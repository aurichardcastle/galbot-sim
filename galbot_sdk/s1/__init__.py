"""galbot_sdk.s1 — S1 platform wrappers (GalbotSim).

Verbatim port of the official ``s1/__init__.py`` wrapper pattern
(api_contract.md §1), pre-bound to ``MachineType.S1``: re-exports the entire
...
singletons obtained through ``get_instance(MachineType.S1)``.
...
class GalbotRobot:
    """No-arg singleton wrapper over the base GalbotRobot, bound to S1."""
...
class GalbotMotion:
    """No-arg singleton wrapper over the base GalbotMotion, bound to S1."""
...
class GalbotNavigation:
    """No-arg singleton wrapper over the base GalbotNavigation, bound to S1."""
